...
from data_play.main.convert.converter import handle_web_request
from data_play.main.data_type.data_type_master import DataTypeMaster
from data_play.main.data_type.dev import Dev
from data_play.main.data_type.known_issues import KnownIssues
...
def process_data():
    ...
    for data_type in data_types:
        ...
        if not data_cli:
            ...
            #
            data_type.set_content_mappings()
            data_type.set_name_mappings()
            #
