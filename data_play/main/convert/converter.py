...
def print_data(data=None, meta_data=None, info_data=None, master_data=None):
    ...
    if data.print_info:
        ...
        info = PhConstants.SEPERATOR_MULTI_OBJ.join(filter(None, [
            ...
            PhUtil.get_dic_data_and_print(PhKeys.CONTENT_MAPPINGS, PhConstants.SEPERATOR_ONE_LINE,
                                          data.content_mappings, dic_format=False,
                                          print_also=False) if data.content_mappings else None,
            PhUtil.get_dic_data_and_print(PhKeys.NAME_MAPPINGS, PhConstants.SEPERATOR_ONE_LINE, data.name_mappings,
