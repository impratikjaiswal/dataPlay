...
from data_play.main.helper.defaults import Defaults, DefaultTypesInclude
...
def dict_to_data(config_data):
    data_types_include = {
        ...
        # Specific Param
        PhKeys.CONTENT_MAPPINGS: DefaultTypesInclude.CONTENT_MAPPINGS,
        PhKeys.NAME_MAPPINGS: DefaultTypesInclude.NAME_MAPPINGS,
    }
    data_types_exclude = {
        # Common Param
