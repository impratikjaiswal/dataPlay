...
class TestAutoBatch:
    BATCH_RUN_TC = 'run_tc_data_play.bat'

    MODULE_NAME = 'data_play.main.dataplay'

    PROJECT_PATH = r'D:\Other\Github_Self\dataPlay'

    get_file_path_mapping_relative = {
        PhKeys.VAR_EXECUTION_MODE: r'data_play\main\dataplay.py',
        PhKeys.VAR_ERROR_HANDLING_MODE: r'data_play\main\dataplay.py',
        PhKeys.VAR_TOP_FOLDER_PATH: r'data_play\main\helper\folders.py',
    }
    ...
    def prepare_batch_file(cls, test_case_data):
        ...
        log_file_path = os.sep.join(['data_play', 'test', 'logs', test_case_data.get(PhKeys.TEST_CASE_FILE_NAME)])
